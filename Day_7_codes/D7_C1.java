...
Create class Employee with attributes id, name, salary and department. Create a collection of few Employee objects. Find the average of salaries 
             of employees who belong to the “development” departmentes of pair whose sum will be equal to the given target.
...
class Main {
    ...
    public static void main(String[] args) {
        ...
        if (count > 0) {
            ...
            System.out.println("No employees in development department.");
        }
    }
}
